package org.yeyr2.as12306.ticketService.job;
...
import org.yeyr2.as12306.ticketService.job.base.AbstractTrainStationJobHandlerTemplate;
    ...
    protected void actualExecute(List<TrainDO> trainDOPageRecords) {
        for (TrainDO each : trainDOPageRecords) {
            ...
            for (TrainStationRelationDO item : trainStationRelations) {
                ...
                String buildCacheKey = RedisKeyConstant.TRAIN_STATION_DETAIL + CacheUtil.buildKey(String.valueOf(each.getId()), item.getDeparture(), item.getArrival());
