...
package org.yey2.as12306.ticketService.service.handler.ticket.tokenbucket;
...
import org.yey2.as12306.ticketService.remote.dto.resp.TicketOrderDetailRespDTO;
...
import static org.yey2.as12306.ticketService.common.constant.As12306Constant.ADVANCE_TICKET_DAY;
...
public final class TicketAvailabilityTokenBucket {
    ...
    public boolean takeTokenFromBucket(PurchaseTicketReqDTO requestParam) {
        ...
        if (!hasKey) {
            // 如果没有座位信息,则从数据库中将该车次的各座位信息存入redis
...
//                                    StrUtil.join("_", each.getStartStation(), each.getEndStation(), eachSeatTypeCountDTO.getSeatType());
...
//                StrUtil.join("_", requestParam.getDeparture(), requestParam.getArrival());
