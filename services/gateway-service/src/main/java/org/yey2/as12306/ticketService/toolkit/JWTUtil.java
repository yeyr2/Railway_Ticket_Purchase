...
import static org.yeyr2.as12306.base.constant.UserConstant.*;
...
public final class JWTUtil {
    ...
    public static String generateAccessToken(UserInfoDTO userInfo) {
        ...
        customerUserMap.put(USER_ID, userInfo.getUserId());
        customerUserMap.put(USERNAME, userInfo.getUsername());
        customerUserMap.put(USER_REAL_NAME, userInfo.getRealName());
